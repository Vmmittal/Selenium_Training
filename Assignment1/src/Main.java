...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.setProperty("webdriver.edge.driver",
                "E:\\cloudEQ\\selenium_proj1\\src\\drivers\\msedgedriver.exe");
        ...
        phone.sendKeys("7027076978");

        Thread.sleep(1000);

        WebElement username = driver.findElement(By.name("userName"));
        username.sendKeys("vipul.kumar@cloudeq.com");
        ...
        password.sendKeys("Vipul@12345");

        Thread.sleep(1000);

        WebElement confirmPassword = driver.findElement(By.name("confirmPassword"));
        confirmPassword.sendKeys("Vipul@12345");
